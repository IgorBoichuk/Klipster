...
export const SingleProductCrad = () => {
  return (
    <div className="flex items-center flex-col rounded-xl shadow-md overflow-hidden h-full mt-5">
      ...
      <div className="p-4 grid grid-cols-1 gap-2">
        ...
        <button className="add-to-cart cursor-pointer rounded-xl bg-amber-300 h-9 w-4/5 m-auto">
          В корзину
        </button>
