...
const Delivery = () => {
	return (
		<Container>
			...
			<p className='p-1'>Оплата на рахунок. Оплата по реквізитах для фізичних та юридичних осіб Реквізити на оплату:</p>
			...
			<p className='p-1'>"Після оплати по реквізитам обовязково скинути скрін оплати на вайбер"</p>
		</Container>
	);
};
